    ...
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        <div>
          ...
          <p className={styles.pageSubtitle}>Create and manage news articles</p>
        </div>
      </div>
      <div className={styles.comingSoon}>
        <div className={styles.comingSoonIcon}>📰</div>
        <h2>Coming Soon</h2>
        <p>This section is under development. Check back soon for full News management functionality.</p>
      </div>
    </div>
  );
}
